...
export const AIChatSidePanel: React.FC<AIChatSidePanelProps> = ({
  ...
  // CHANGE 1: Fixed getChatModePrompt function - proper string formatting
  ...
  const handleSendMessage = async (e: React.FormEvent) => {
     ...
     // CHANGE 2: Fixed messageType assignment - use underscore for code_review
     const messageType = 
       chatMode === "chat" ? "chat" :
  ...
  // CHANGE 3: Fixed exportChat function - add basic implementation
  const exportChat = () => {

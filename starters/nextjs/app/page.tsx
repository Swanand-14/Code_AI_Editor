...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <div className="z-10 my-8 max-w-2xl w-full">
        <div className="rounded-lg border border-blue-300 bg-blue-50 dark:bg-blue-900/20 dark:border-blue-700 p-6">
          <h2 className="text-lg font-semibold mb-4 text-blue-900 dark:text-blue-300">
            🧭 Test Navigation
          </h2>
          <p className="text-sm text-blue-800 dark:text-blue-400 mb-4">
            Click the links below to test page navigation in your Next.js app:
          </p>
